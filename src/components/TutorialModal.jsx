...
const SECTIONS_BUREAU = [
  ...
  },
  {
    ...
    contenu: [
      ...
      `Ce QR code est celui que respos-sports scannera pour vérifier la licence.`,
    ],
  },
  {
  ...
  },
  {
    ...
    contenu: [
      ...
      `"Modifier le mot de passe de respos-sports" : réinitialisez le mot de passe du compte respos-sports partagé si nécessaire.`,
